    ...
    <div class="uk-width-1-3@m uk-width-1-2@s uk-animation-slide-right-medium">
        <div class="px-5">
            <div class="my-4 uk-text-center">
                <h1 class="mb-2 text-dark"> Create new account</h1>
                <p class="my-2 text-dark">Already have an account?
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="uk-form-group">
                    <div class="uk-position-relative">
                        <input type="text" class="uk-input bg-secondary @error('name') is-invalid @enderror"
                               id="email"
                ...
                <div class="uk-form-group">
                    <div class="uk-position-relative">
                        <input type="password" class="uk-input bg-secondary @error('password_confirmation') is-invalid @enderror"
                               id="password" placeholder="Comfirm Password" name="password_confirmation" required
                               autocomplete="current-password">
                    </div>
                </div>
                ...
                @endif
                <button type="submit" class="button primary large block mb-4">Register Now</button>
                {{--                <a href="#" class="text-center uk-display-block">--}}
                {{--                    <label><input class="uk-checkbox mr-2" type="checkbox"> I Agree terms </label>--}}
                {{--                </a>--}}
            </form>
            <div class="or-container" style="margin-top: 25px">
