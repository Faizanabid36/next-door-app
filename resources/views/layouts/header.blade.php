...
<!-- BEGIN: Body-->
<body
    class="vertical-layout {{Request::is('sale-and-business')?"content-detached-left-sidebar ecommerce-application":"2-columns"}} vertical-menu-modern semi-dark-layout navbar-floating footer-static  "
