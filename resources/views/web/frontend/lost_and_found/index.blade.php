...
{{--                    </div>--}}
{{--                </div>--}}
                <div id="laoding-data"><p class="text-dark text-center">Please Wait, while the
                        data is being loaded...!</p>
                </div>
            </div>
            <div class="uk-width-expand">
                <div class="group-card">
                    <div class="group-card-content">
                        <h2 class="text-dark text-center mb-0"> <i>About Lost Items</i> </h2>
                        <hr>
                        <p class="info m-2">
